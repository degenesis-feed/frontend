            ...
            <div className="flex space-x-2">
              ...
              <button className="p-2 text-orange-500 hover:bg-orange-50 rounded-full transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M20.692 10.69C20.692 5.9 16.792 2 12 2s-8.692 3.9-8.692 8.69c0 1.902.603 3.708 1.743 5.223l.003-.002.007.015c1.628 2.07 6.278 5.757 6.475 5.912.138.11.33.17.52.17.193 0 .385-.06.523-.17.198-.155 4.847-3.84 6.475-5.912l.007-.014.002.002c1.14-1.516 1.743-3.32 1.743-5.223zM12 20.29c-1.224-.99-4.52-3.715-5.756-5.285-.94-1.25-1.436-2.742-1.436-4.312C4.808 6.727 8.035 3.5 12 3.5s7.192 3.226 7.192 7.19c0 1.57-.497 3.062-1.436 4.313-1.236 1.57-4.532 4.294-5.756 5.285z"></path>
                </svg>
              </button>
            </div>
            <button
          ...
          <div className="flex">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex justify-between max-w-md">
                ...
                <button className="flex items-center text-gray-500 hover:text-pink-500 group">
